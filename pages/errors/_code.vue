<template>
  <div class="error_code">
    <h1>error code is {{ errorCode }}</h1>
    <p>{{ information[errorCode] }}</p>
    <a
      href="https://ko.wikipedia.org/wiki/HTTP_%EC%83%81%ED%83%9C_%EC%BD%94%EB%93%9C"
      >https://ko.wikipedia.org/wiki/HTTP_상태코드</a
    >
  </div>
</template>
  ...
  data() {
    return {
      information: {
        ...
        424: '(실패된 의존성, WebDAV; RFC 4918), (메쏘드 실패, WebDAV)',
        ...
        451: '(법적인 이유로 이용 불가, 인터넷 초안), (리다이렉션, 마이크로소프트)',
